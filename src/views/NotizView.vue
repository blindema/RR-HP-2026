...
function write_notizen() {
  ...
  axios({
    ...
    .then(function (response) {
      ...
      console.log(`Saetze gelesen: ${notizen.value.length}`)
...
/** Function
 * Fkt. wird ausgeführt, bevor die Page von Vue geladen wird
 */
 //onBeforeMount(() => {
  //editorContent.value = { ops: [{ insert: '\n' }] }; 
 //});
